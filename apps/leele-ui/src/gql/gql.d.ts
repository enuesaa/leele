...
export type introspection_types = {
    ...
    'Query': { kind: 'OBJECT'; name: 'Query'; fields: { 'notes': { name: 'notes'; type: { kind: 'NON_NULL'; name: never; ofType: { kind: 'LIST'; name: never; ofType: { kind: 'NON_NULL'; name: never; ofType: { kind: 'OBJECT'; name: 'Note'; ofType: null; }; }; }; } }; }; };
    'String': unknown;
